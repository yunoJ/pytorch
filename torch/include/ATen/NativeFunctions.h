...
CAFFE2_API Tensor & ARCcopy_(Tensor & self, const Tensor & src, bool non_blocking=false, bool is_csr=false);
...
#endif
CAFFE2_API Tensor ARCempty_cuda(IntArrayRef size, const TensorOptions & options={}, c10::optional<MemoryFormat> memory_format=c10::nullopt);
...
CAFFE2_API Tensor ARCto(const Tensor & self, const TensorOptions & options, bool non_blocking=false, bool copy=false, bool is_csr=false);
CAFFE2_API Tensor to(const Tensor & self, Device device, ScalarType dtype, bool non_blocking=false, bool copy=false);
CAFFE2_API Tensor ARCto(const Tensor & self, Device device, ScalarType dtype, bool non_blocking=false, bool copy=false, bool is_csr=false);
CAFFE2_API Tensor to(const Tensor & self, ScalarType dtype, bool non_blocking=false, bool copy=false);
CAFFE2_API Tensor ARCto(const Tensor & self, ScalarType dtype, bool non_blocking=false, bool copy=false, bool is_csr=false);
CAFFE2_API Tensor to(const Tensor & self, const Tensor & other, bool non_blocking=false, bool copy=false);
CAFFE2_API Tensor ARCto(const Tensor & self, const Tensor & other, bool non_blocking=false, bool copy=false, bool is_csr=false);
