...
Tensor & ARCcopy_(Tensor & self, const Tensor & src, bool non_blocking, bool is_csr); // aten::ARCcopy_(Tensor(a!) self, Tensor src, bool non_blocking=False, bool is_csr=False) -> Tensor(a!)
...
Tensor ARCempty(IntArrayRef size, const TensorOptions & options, c10::optional<MemoryFormat> memory_format); // aten::ARCempty(int[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor
...
Tensor ARCto(const Tensor & self, const TensorOptions & options, bool non_blocking, bool copy, bool is_csr); // aten::ARCto(Tensor self, *, ScalarType dtype, Layout layout, Device device, bool pin_memory=False, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor
...
Tensor ARCto(const Tensor & self, Device device, ScalarType dtype, bool non_blocking, bool copy, bool is_csr); // aten::ARCto(Tensor self, Device device, ScalarType dtype, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor
...
Tensor ARCto(const Tensor & self, ScalarType dtype, bool non_blocking, bool copy, bool is_csr); // aten::ARCto(Tensor self, ScalarType dtype, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor
...
Tensor ARCto(const Tensor & self, const Tensor & other, bool non_blocking, bool copy, bool is_csr); // aten::ARCto(Tensor self, Tensor other, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor
