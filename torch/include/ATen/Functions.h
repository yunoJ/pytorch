...
#endif
static inline Tensor ARCempty(IntArrayRef size, const TensorOptions & options={}, c10::optional<MemoryFormat> memory_format=c10::nullopt);
...
#endif
static inline Tensor ARCempty(IntArrayRef size, const TensorOptions & options, c10::optional<MemoryFormat> memory_format) {
    globalLegacyTypeDispatch().initForBackend(options.backend());
    static auto table = globalATenDispatch().getOpTable("aten::ARCempty(int[] size, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor");
