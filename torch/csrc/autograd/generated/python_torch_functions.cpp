...
//    at::globalContext().ARCGlobal.setNewTid(output);
//    if (at::globalContext().ARCGlobal.isDebugMode()) {
//      std::cout << "Tensor OUTPUT TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
//    }
//  }
...
static PyObject * THPVariable__fused_dropout(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "_fused_dropout output0 TENSOR ID: " << at::globalContext().ARCGlobal.getTid(std::get<0>(output)) << std::endl;
    std::cout << "_fused_dropout output1 TENSOR ID: " << at::globalContext().ARCGlobal.getTid(std::get<1>(output)) << std::endl;
  }

  if (at::globalContext().ARCGlobal.isOnDemand() && std::get<0>(output).device().type() == at::DeviceType::CPU) {
...
static PyObject * THPVariable_adaptive_max_pool1d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (at::globalContext().ARCGlobal.isOnDemand() && std::get<0>(outputs).device().type() == at::DeviceType::CPU) {
...
static PyObject * THPVariable_add(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "add output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_addmm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(5)) {
      output = dispatch_addmm(r.scalar(0), input, r.scalar(2), r.tensor(3), r.tensor(4));
    } else {
      output = dispatch_addmm(r.scalar(0), input, r.scalar(2), r.tensor(3), r.tensor(4), r.tensor(5));
    }
  } else if (r.idx == 1) {
    if (r.isNone(4)) {
      output = dispatch_addmm(r.scalar(0), input, r.tensor(2), r.tensor(3));
    } else {
      output = dispatch_addmm(r.scalar(0), input, r.tensor(2), r.tensor(3), r.tensor(4));
    }
  } else if (r.idx == 2) {
    ...
    if (r.isNone(5)) {
      ...
      output = dispatch_addmm(mat1, input, mat2, r.scalar(3), r.scalar(4), r.tensor(5));
    }
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "addmm output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_batch_norm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATION BATCH_NORM, OPID: ";
    std::cout << oid << std::endl;
  }
  Tensor input = r.tensor(0);
...
//  at::globalContext().ARCGlobal.setNewTid(weight);
  ...
  Tensor output;
  if (r.idx == 0) {
    output = dispatch_batch_norm(input, weight, r.tensor(2), r.tensor(3), r.tensor(4), r.toBool(5), r.toDouble(6), r.toDouble(7), r.toBool(8));
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "batch_norm output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_cat(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (r.idx == 0) {
    if (r.isNone(2)) {
      output = dispatch_cat(r.tensorlist(0), r.toInt64(1));
    } else {
      output = dispatch_cat(r.tensorlist(0), r.toInt64(1), r.tensor(2));
    }
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "CAT output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_conv2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATION CONV2D, OPID: ";
    std::cout << oid << std::endl;
  }
  Tensor input = r.tensor(0);
...
//  at::globalContext().ARCGlobal.setNewTid(output);
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "conv2d output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
//  at::globalContext().ARCGlobal.setNewTid(weight);
  ...
  Tensor output;
  if (r.idx == 0) {
    output = dispatch_conv_transpose2d(input, weight, r.tensor(2), r.intlist(3), r.intlist(4), r.intlist(5), r.toInt64(6), r.intlist(7));
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "conv_transpose2d output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_dropout(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATION DROPOUT, OPID: ";
    std::cout << oid << std::endl;
  }
  Tensor input = r.tensor(0);
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "DROPOUT OUTPUT TENSOR: " << otid << std::endl;
  }
...
static PyObject * THPVariable_embedding(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  /*auto itid = at::globalContext().ARCGlobal.getTid(input);
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "EMBEDDING INPUT TID: " << itid << std::endl;
  }*/
...
//  at::globalContext().ARCGlobal.setNewTid(weight);
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "embedding output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }

  //DEBUG
  /*auto otid = at::globalContext().ARCGlobal.getTid(output);
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "EMBEDDING OUTPUT TID: " << otid << std::endl;
  }*/
...
static PyObject * THPVariable_flatten(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "flatten output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
//  at::globalContext().ARCGlobal.setNewTid(weight);
  ...
  Tensor output;
  if (r.idx == 0) {
    output = dispatch_instance_norm(input, weight, r.tensor(2), r.tensor(3), r.tensor(4), r.toBool(5), r.toDouble(6), r.toDouble(7), r.toBool(8));
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "instance_norm output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_max_pool2d(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATION MAX_POOL2D, OPID: ";
    std::cout << oid << std::endl;
  }
  Tensor input = r.tensor(0);
  ...
  Tensor output;
  if (r.idx == 0) {
    output = dispatch_max_pool2d(input, r.intlist(1), r.intlist(2), r.intlist(3), r.intlist(4), r.toBool(5));
  }
  
  //output tid is already set
  //at::globalContext().ARCGlobal.setNewTid(output);
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "max_pool2d output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_quantized_lstm(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  HANDLE_TH_ERRORS
  static PythonArgParser parser({
    "quantized_lstm(Tensor input, TensorList hx, TensorList params, bool has_biases, int64_t num_layers, double dropout, bool train, bool bidirectional, bool batch_first, *, ScalarType? dtype=None)",
  }, /*traceable=*/true);
  ...
  if (r.idx == 0) {
    return wrap(dispatch_quantized_lstm(r.tensor(0), r.tensorlist(1), r.tensorlist(2), r.toBool(3), r.toInt64(4), r.toDouble(5), r.toBool(6), r.toBool(7), r.toBool(8), r.scalartypeOptional(9)));
  }
  Py_RETURN_NONE;
  END_HANDLE_TH_ERRORS
}
...
static PyObject * THPVariable_relu(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATOIN ReLU, OPID: " << oid << std::endl;
  }
  Tensor input = r.tensor(0);
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "relu output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_sqrt(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  auto oid = at::globalContext().ARCGlobal.getNewOid();
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "OPERATION SQRT, OPID: ";
    std::cout << oid << std::endl;
  }
  Tensor input = r.tensor(0);

  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "SQRT INPUT TENSOR ID: " << at::globalContext().ARCGlobal.getTid(input) << std::endl;
  }
  ...
  if (r.idx == 0) {
    if (r.isNone(1)) {
      output = dispatch_sqrt(input);
    } else {
      output = dispatch_sqrt(input, r.tensor(1));
    }
  }
  ...
  if (at::globalContext().ARCGlobal.isDebugMode()) {
    std::cout << "SQRT OUTPUT TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
  }
...
static PyObject * THPVariable_zeros_like(PyObject* self_, PyObject* args, PyObject* kwargs)
{
  ...
  if ( at::globalContext().ARCGlobal.isBERT()) {
    ...
    if (at::globalContext().ARCGlobal.isDebugMode()) {
      std::cout << "zeros_like output TENSOR ID: " << at::globalContext().ARCGlobal.getTid(output) << std::endl;
    }
  }
...
static PyMethodDef torch_functions[] = {
  ...
  {"_has_compatible_shallow_copy_type", (PyCFunction)THPVariable__has_compatible_shallow_copy_type, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"_lu_solve_helper", (PyCFunction)THPVariable__lu_solve_helper, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"batch_norm_gather_stats_with_counts", (PyCFunction)THPVariable_batch_norm_gather_stats_with_counts, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"bitwise_not", (PyCFunction)THPVariable_bitwise_not, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"fake_quantize_per_tensor_affine", (PyCFunction)THPVariable_fake_quantize_per_tensor_affine, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"fbgemm_is_cpu_supported", (PyCFunction)THPVariable_fbgemm_is_cpu_supported, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  {"fbgemm_linear_fp16_weight", (PyCFunction)THPVariable_fbgemm_linear_fp16_weight, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"fbgemm_pack_gemm_matrix_fp16", (PyCFunction)THPVariable_fbgemm_pack_gemm_matrix_fp16, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"miopen_rnn", (PyCFunction)THPVariable_miopen_rnn, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"quantized_gru", (PyCFunction)THPVariable_quantized_gru, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
  ...
  {"quantized_max_pool2d", (PyCFunction)THPVariable_quantized_max_pool2d, METH_VARARGS | METH_KEYWORDS | METH_STATIC, NULL},
