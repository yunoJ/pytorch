...
static auto& registerer = globalATenDispatch()
  ...
  .registerVariableOp<Tensor & (Tensor &, const Tensor &, bool, bool)>("aten::ARCcopy_(Tensor(a!) self, Tensor src, bool non_blocking=False, bool is_csr=False) -> Tensor(a!)", &VariableType::ARCcopy_)
