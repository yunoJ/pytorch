...
RegisterOperators reg({
  ...
  // Generated operators
  Operator(
      "aten::ARCcopy_(Tensor(a!) self, Tensor src, bool non_blocking=False, bool is_csr=False) -> Tensor(a!)",
      [](Stack & stack) {
          auto self = (std::move(peek(stack, 0, 4))).toTensor();
          auto result_ = (self).ARCcopy_(
  ...
  Operator(
      "aten::ARCempty(int[] size, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::avg_pool3d(Tensor self, int[3] kernel_size, int[3] stride=[], int[3] padding=0, bool ceil_mode=False, bool count_include_pad=True, int? divisor_override=None, *, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::normal(float mean, float std, int[] size, *, Generator? generator=None, Tensor(a!) out) -> Tensor(a!)",
      [](Stack & stack) {
          auto out = (std::move(peek(stack, 4, 5))).toTensor();
          auto result_ = at::normal_out(
              out,
