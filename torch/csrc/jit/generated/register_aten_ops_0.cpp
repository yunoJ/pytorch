...
RegisterOperators reg({
  ...
  // Generated operators
  Operator(
      "aten::ARCto(Tensor self, Tensor other, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor",
      [](Stack & stack) {
      
          auto result_ = ((std::move(peek(stack, 0, 5))).toTensor()).ARCto(
  ...
  Operator(
      "aten::ARCto(Tensor self, ScalarType dtype, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor",
      [](Stack & stack) {
  ...
  Operator(
      "aten::ARCto(Tensor self, Device device, ScalarType dtype, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor",
      [](Stack & stack) {
      
          auto result_ = ((std::move(peek(stack, 0, 6))).toTensor()).ARCto(
  ...
  Operator(
      "aten::ARCto(Tensor self, *, ScalarType dtype, Layout layout, Device device, bool pin_memory=False, bool non_blocking=False, bool copy=False, bool is_csr=False) -> Tensor",
      [](Stack & stack) {
          ...
          auto result_ = ((std::move(peek(stack, 0, 8))).toTensor()).ARCto(options,
  ...
  Operator(
      "aten::avg_pool2d_backward(Tensor grad_output, Tensor self, int[2] kernel_size, int[2] stride, int[2] padding, bool ceil_mode, bool count_include_pad, int? divisor_override, *, Tensor(a!) grad_input) -> Tensor(a!)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::quantized_gru(Tensor data, Tensor batch_sizes, Tensor hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional) -> (Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::quantized_gru(Tensor input, Tensor hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional, bool batch_first) -> (Tensor, Tensor)",
      [](Stack & stack) {
  ...
  Operator(
      "aten::quantized_lstm(Tensor input, Tensor[] hx, Tensor[] params, bool has_biases, int num_layers, float dropout, bool train, bool bidirectional, bool batch_first, *, ScalarType? dtype=None) -> (Tensor, Tensor, Tensor)",
      [](Stack & stack) {
      
          auto result_ = at::quantized_lstm(
              (std::move(peek(stack, 0, 10))).toTensor(),
              (std::move(peek(stack, 1, 10))).toTensorListRef(),
              (std::move(peek(stack, 2, 10))).toTensorListRef(),
              (std::move(peek(stack, 3, 10))).toBool(),
              (std::move(peek(stack, 4, 10))).toInt(),
              (std::move(peek(stack, 5, 10))).toDouble(),
              (std::move(peek(stack, 6, 10))).toBool(),
              (std::move(peek(stack, 7, 10))).toBool(),
              (std::move(peek(stack, 8, 10))).toBool(),
              (std::move(peek(stack, 9, 10))).toOptional<ScalarType>()
          );
          drop(stack, 10);
          pack(stack, std::move(result_));
          return 0;
